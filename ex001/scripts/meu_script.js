...
function recarregar(){
    if (hora >= 0 && hora < 6){
       ...
       text.innerHTML = `Agora são ${hora} horas da madrugada. <br>
       Bom Dia!`
       img.src = 'Madrugada.jpg'
        ...
        text.innerHTML = `Agora são ${hora} horas da manhã. <br>
        Bom Dia!`
        img.src = 'Manhã.jpg'
    }
        ...
        text.innerHTML = `Agora são ${hora} horas da tarde. <br>
        Boa Tarde!`
        img.src = 'Tarde.jpg'
    } else {
        // Noite
        document.body.style.background = '#2F3D4A'
        text.innerHTML = `Agora são ${hora} horas da noite. <br>
        Boa Noite!`
        img.src = 'Noite.jpg'
    }
}